...
class Pricing {
  ...
  validateCalculations(inputPrice) {
    ...
    return prices.subscriptionBeforeDiscount === expectedSubscriptionBeforeDiscount && prices.finalMain === expectedFinalMain && prices.finalSubscription === expectedFinalSubscription;
  }
}
