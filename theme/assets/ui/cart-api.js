  ...
  return _createClass(CartAPI, [{
    ...
    value: function () {
      var _addToCart = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(items) {
        var _this = this;
        var normalizedItems, validation, payload, response, errorData, message, cart, _message, _t;
        return _regenerator().w(function (_context) {
          while (1) switch (_context.p = _context.n) {
            ...
            case 2:
              payload = {
                items: normalizedItems.map(function (item) {
                  return _this.normalizeItem(item);
                })
              };
              _context.p = 3;
              _context.n = 4;
              return this.fetchImpl(this.endpoints.add, {
                method: 'POST',
                headers: {
            ...
            case 9:
              _context.p = 9;
              _t = _context.v;
              _message = _t instanceof Error ? _t.message : 'Unable to add to cart';
              return _context.a(2, {
                success: false,
                error: _message,
                cart: null
        ...
        return _regenerator().w(function (_context2) {
          while (1) switch (_context2.p = _context2.n) {
            ...
            case 1:
              _context2.p = 1;
              _context2.n = 2;
              return this.fetchImpl(this.endpoints.cart, {
                method: 'GET',
                headers: {
                  Accept: 'application/json'
                }
    ...
    key: "normalizeItem",
    value: function normalizeItem(item) {
      return {
        id: Number(item.id),
        quantity: this.normalizeQuantity(item.quantity),
        properties: item.properties ? _objectSpread({}, item.properties) : {}
      };
    }
  }, {
    key: "normalizeQuantity",
    value: function normalizeQuantity(quantity) {
      var value = Number.isInteger(quantity) ? Number(quantity) : 1;
    ...
    value: function isValidVariantId(id) {
      var numericId = Number.parseInt(String(id), 10);
